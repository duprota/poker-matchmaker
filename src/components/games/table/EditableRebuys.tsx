...
export const EditableRebuys = ({ playerId, initialValue, onSave }: EditableRebuysProps) => {
  ...
  if (isEditing) {
    return (
      <div className="flex justify-end gap-2">
        ...
        />
        <Button variant="ghost" size="icon" onClick={handleSave} aria-label="Save rebuy amount">
  ...
  return (
    <div className="flex justify-end gap-2">
      ...
      <Button variant="ghost" size="icon" onClick={() => setIsEditing(true)} aria-label="Edit rebuy amount">
