          ...
          <TooltipTrigger asChild>
            <Popover open={open} onOpenChange={setOpen}>
              <PopoverTrigger asChild>
                <Button size="icon" variant={totalHandsCount > 0 ? "outline" : "ghost"} className="relative" aria-label="Registrar jogadas especiais">
                  {totalHandsCount > 0 ? <div className="flex items-center justify-center">
                    ...
                    </div> : <span className="text-slate-500">
              ...
              <PopoverContent className="w-auto flex flex-col gap-3 px-3 py-3 bg-zinc-900">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    return <div key={option.value} className="flex items-center justify-between bg-muted/30 rounded-md p-2">
                          ...
                          <div className="flex items-center gap-1">
                            <Button size="icon" variant="ghost" className="h-6 w-6 text-xs rounded-full" onClick={() => decrementHand(option.value)} disabled={handCount === 0} aria-label={`Diminuir ${option.label}`}>
                              -
                            </Button>
                            ...
                            <Button size="icon" variant="ghost" className="h-6 w-6 text-xs rounded-full" onClick={() => incrementHand(option.value)} aria-label={`Aumentar ${option.label}`}>
                              +
                            </Button>
                          </div>
                        </div>;
                ...
                <div className="flex items-center justify-between border-t pt-2 mt-1">
                  ...
                  <Button size="sm" variant="ghost" className="text-xs text-muted-foreground hover:text-destructive" onClick={clearAllHands} disabled={totalHandsCount === 0} aria-label="Limpar todas as jogadas">
                    Limpar
                  </Button>
                </div>
              </PopoverContent>
...
export const EmojiSVGDefs = () => <svg style={{
  display: "none"
