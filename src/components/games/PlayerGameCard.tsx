          ...
          <div className="relative">
            ...
            <div className="p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                {onRemovePlayer && <Button variant="ghost" size="icon" className="absolute top-3 right-3 text-muted-foreground hover:text-destructive" onClick={() => setConfirmRemove(true)} aria-label="Remove player">
